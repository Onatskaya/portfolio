...
speedTest.init = function() {
  var latlng = new google.maps.LatLng(49.993499, 36.230376);
  var options = {
    'zoom': 12,
    'center': latlng,
...
speedTest.showMarkers = function() {
  ...
  for (var i = 0; i < numMarkers; i++) {
    ...
    var imageUrl = 'logo-icon.png';
    var markerImage = new google.maps.MarkerImage(imageUrl,
        new google.maps.Size(102, 35));
...
speedTest.markerClickFunction = function(pic, latlng) {
  return function(e) {
    ...
    var titles = pic.photo_titles;
    var phone = pic.photo_titless;
